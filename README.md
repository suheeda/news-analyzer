...
Tech Stack: Python 🐍, Streamlit 🌐, NewsAPI 🗞️, NLTK 🧠, TextBlob ✨, Pandas 📊, Plotly 📈
...
Real-time News Fetching 🗞️ – Collects the latest news articles using NewsAPI.

Sentiment Analysis 😊😐😡 – Classifies news as positive, neutral, or negative using NLTK and TextBlob.
...
NewsAPI – Fetch real-time news 🗞️
...
Natural Language Processing (NLP) with NLTK & TextBlob 🧠

Data visualization with Plotly 📈

Interactive dashboards with Streamlit 🌐

Working with APIs (NewsAPI) 🗞️
